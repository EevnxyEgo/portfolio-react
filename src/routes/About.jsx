...
export default function About() {
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-10 pt-16 sm:px-10">
        <Reveal>
          <h1 className="font-display text-display text-ink">About</h1>
        </Reveal>

        <Reveal delay={0.06}>
          <div className="mt-8 flex max-w-[60ch] flex-col gap-5 text-lg leading-relaxed text-ink-soft">
            <p className="text-xl text-ink">
              I&rsquo;m a full-stack developer based in Indonesia. I like building complete things —
              not demos that fall apart when you click the second button, but products that ship, hold
              up, and read as considered.
            </p>
            <p>
              Most of what I make starts as a problem I actually have: a way to learn React that shows
              you the re-renders, a job-hunt tool that keeps your data on your own machine, a booking
              flow that feels designed rather than assembled.
            </p>
            <p>
              ...
              four camera modes and a finite-state machine, all in Unreal Engine 5. That range is the
              throughline: I&rsquo;ve shipped web apps, trained ML models, done computer vision, and
              built real-time 3D. The common thread isn&rsquo;t a single stack — it&rsquo;s finishing.
            </p>
            <p>
              Right now I&rsquo;m in the Korea–ASEAN Digital Academy, an intensive full-stack program,
              sharpening the web side. Before that I interned as a software engineer at IDstar, where I
              automated the busywork out of a recruitment pipeline.
            </p>
